...
namespace FaaS.Entities.Repositories
{
    public class ElementRepository : IElementRepository
    {
        ...
        public async Task<Element> Get(Guid formId, string name)
            => await _context
            .Elements
            .Where(element => element.Name == name && element.FormId == formId)
            .SingleOrDefaultAsync();

        public Task<Element> Get(Form form, string name) =>
            this.Get(form.Id, name);
