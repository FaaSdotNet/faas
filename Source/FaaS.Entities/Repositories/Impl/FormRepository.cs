...
namespace FaaS.Entities.Repositories
{
    public class FormRepository : IFormRepository
    {
        ...
        public async Task<Form> Add(Project project, Form form)
        {
            ...
            Project actualProject = _context.Projects.SingleOrDefault(projectForForm => 
                projectForForm.Name == project.Name);
        ...
        public async Task<Form> Update(Form updatedForm)
        {
            ...
            Form oldForm = _context.Forms.SingleOrDefault(form => form.Name == updatedForm.Name);
        ...
        public async Task<Form> Get(Project project, string name) =>
            await Get(project.Id, name);
        ...
        public async Task<Form> Get(Guid projectId, string name)
            => await _context
            .Forms
            .Where(form => form.Name == name && form.ProjectId == projectId)
